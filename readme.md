...
[VKUI](https://github.com/VKCOM/VKUI) библиотеку.

Пока одни навязывают свои компоненты для реализации структуры, порождая за счет этого множество
проблем, другие предоставляют сравнительно сложный интерфейс для реализации простейшей
навигации.

Ну а здесь сравнение веса примечательных мне пакетов:

| Название            | Вес бандла           | Вес бандла в gzip   |
| ------------------- | -------------------- | ------------------- |
